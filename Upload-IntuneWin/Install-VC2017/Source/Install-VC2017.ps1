...
If ($Install) {
    ...
    #Your code goes here
    Start-Process -FilePath "vc_redist.x86.exe" -ArgumentList "/install /quiet"  -Wait -WindowStyle Hidden -ErrorAction Stop
    Start-Process -FilePath "vc_redist.x64.exe" -ArgumentList "/install /quiet"  -Wait -WindowStyle Hidden -ErrorAction Stop
...
ElseIf ( $UnInstall ) {
    ...
    #Your code goes here
    Start-Process -FilePath "vc_redist.x86.exe" -ArgumentList "/uninstall /quiet"  -Wait -WindowStyle Hidden -ErrorAction Stop
    Start-Process -FilePath "vc_redist.x64.exe" -ArgumentList "/uninstall /quiet"  -Wait -WindowStyle Hidden -ErrorAction Stop
