...
If ($Install) {
    ...
    Start-Process -FilePath "KeePass-2.48.1-Setup.exe" -ArgumentList "/VERYSILENT" -Wait -WindowStyle Hidden -ErrorAction Stop
...
ElseIf ( $UnInstall ) {
    ...
    #Your code goes here
    Start-Process -FilePath "C:\Program Files\KeePass Password Safe 2\unins000.exe" -ArgumentList "/VERYSILENT" -Wait -WindowStyle Hidden -ErrorAction Stop 
